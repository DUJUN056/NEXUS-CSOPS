function AuditLogPage(p){
  ...
  var filtered=items.filter(function(x){
    return !search||(x.action&&x.action.toLowerCase().indexOf(search.toLowerCase())>-1)||(x.details&&x.details.toLowerCase().indexOf(search.toLowerCase())>-1);
  });
  ...
  return React.createElement("div",{className:"nx-page-enter"},
    ...
    showForm&&React.createElement("div",{className:"nx-card",style:{padding:20,marginBottom:16}},
      React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:12}},
        React.createElement("input",{className:"nx-input",placeholder:"Title...",value:form.action,onChange:function(e){setForm(function(f){return Object.assign({},f,{action:e.target.value})})}}),
...
function BreakManagementPage(p){
  ...
  function endBreak(id){
    withRetry(function(){return sb.from("breaks").update({end_time:new Date().toISOString(),status:"completed"
                                                          function BreakManagementPage(p){
  var user=p.user;
  var _1=React.useState([]);var items=_1[0];var setItems=_1[1];
  var _2=React.useState(true);var loading=_2[0];var setLoading=_2[1];
        ...
        return React.createElement("div",{key:b.id,className:"nx-card",style:{padding:14}},
          React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,flexWrap:"wrap"}},
            ...
            React.createElement("div",{style:{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}},
              React.createElement("span",{style:{fontSize:12,color:"var(--text-sub)"}},fmtTime(b.start_time)+" to "+(b.end_time?fmtTime(b.end_time):"Active")),
