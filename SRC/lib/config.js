...
var ThemeMgr={
  ...
  getAvailable:function(userRole){
    var all=[
      {id:"dark",label:"Dark",icon:"🌑",desc:"Deep Space",bg:"#00ff88"},
      {id:"light",label:"Light",icon:"☀️",desc:"Clean & Clear",bg:"#00aa55"},
      {id:"ocean",label:"Ocean",icon:"🌊",desc:"Deep Blue",bg:"#06B6D4"},
      {id:"midnight",label:"Midnight",icon:"⚡",desc:"Pure Black",bg:"#00ff88"},
      {id:"grandline",label:"Grand Line",icon:"✨",desc:"Golden Age",bg:"#D97706"},
